...
describe('999 - 1 Test', function () {
    ...
    it('999 - 1 should return 998', async function () {
        ...
        await driver.wait(until.elementTextContains(driver.findElement(By.id("result")), "998"), 3000);
        let resultText = await driver.findElement(By.id("result")).getText();
        assert.strictEqual(resultText, "Result: 998");
